  ...
  // ----------------------------------------------------------------------------------------------
      ...
      while(opciones !=2){
        ...
        if(opciones === 1){ //accedo a ver los productos
          opcionIngresada = parseInt(prompt("ver precios de: \n" + listaProductos.join("\n"))) //me deja ver los precios de los productos
          comprar()
      ...
      function comprar (num) { 
        ...
        if(opcionIngresada === 2){ //SI EL PARAMETRO QUE INGRESA A LA FUNCION Y A EVALUAR ES CERVEZA: PORQUE EVALUO PRODUCTOS?
        ...
        if(opcionIngresada === 3){ //SI EL PARAMETRO QUE INGRESA A LA FUNCION Y A EVALUAR ES CERVEZA: PORQUE EVALUO PRODUCTOS?
